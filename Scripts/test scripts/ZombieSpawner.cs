...
public class ZombieSpawner : MonoBehaviour {
    ...
    private void CreateZombie() {
        ...
        // 좀비 프리팹으로부터 좀비 생성
        zombieData zombie = Instantiate(zombiePrefab, spawnpoint.position, spawnPoints.rotation);
        ...
        // 사망한 좀비를 10초 뒤에 파괴
        zombie.onDeat += () => Destroy(zombie.gameObject, 10f);
        // 좀비 사망 시 좀비 상승
        zombie.onDeath += () => GameManager.instance.AddSorce(100);
    }
}